import{_ as i,o as s,c as a,a as e,b as n}from"./app-2be94d0d.js";const d={},r=e(`<p>本例子我们使用docker来部署一个应用系统，RuoYi是一款用java编写的，基于SpringBoot+Bootstrap的后台管理系统。</p><p>ruoyi官方文档：http://doc.ruoyi.vip/ruoyi/</p><p>源码下载：https://gitee.com/y_project/RuoYi/tree/v4.7.4/</p><p>将源码编译打包成ruoyi-admin.jar文件，放到宿主机/home/app目录下，/home/app/sql目录下是数据库初始化脚本。</p><p>配置文件中修改了端口、数据库连接信息。</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment">#application.yml</span>
