import{_ as i,o as e,c as a,a as n}from"./app-df9604a6.js";const s="/assets/20231206152211-1085afff.png",l="/assets/20231206152502-0623ae8e.png",d="/assets/20231206152547-0b0820f3.png",t="/assets/20231206161215-3559b938.png",r="/assets/20231206161307-8e9167f8.png",c="/assets/20231206162858-059f72e6.png",u="/assets/20231206163045-4b629d7d.png",v="/assets/20231206163711-a4f78dd1.png",m={},o=n(`<h2 id="git分布式版本控制工具" tabindex="-1"><a class="header-anchor" href="#git分布式版本控制工具" aria-hidden="true">#</a> Git分布式版本控制工具</h2><h2 id="_1-、目标" tabindex="-1"><a class="header-anchor" href="#_1-、目标" aria-hidden="true">#</a> 1 、目标</h2><ul><li>了解Git基本概念</li><li>能够概述git工作流程</li><li>能够使用Git常用命令</li><li>熟悉Git代码托管服务</li><li>能够使用idea操作git</li></ul><h2 id="_2-、概述" tabindex="-1"><a class="header-anchor" href="#_2-、概述" aria-hidden="true">#</a> 2 、概述</h2><h3 id="_2-1、开发中的实际场景" tabindex="-1"><a class="header-anchor" href="#_2-1、开发中的实际场景" aria-hidden="true">#</a> 2.1、开发中的实际场景</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>场景一：备份
...
流和正经牛都不承认是自己干的！
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2、版本控制器的方式" tabindex="-1"><a class="header-anchor" href="#_2-2、版本控制器的方式" aria-hidden="true">#</a> 2.2、版本控制器的方式</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>a、集中式版本控制工具
...
修改了。
 ...
 举例：Git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3、svn" tabindex="-1"><a class="header-anchor" href="#_2-3、svn" aria-hidden="true">#</a> 2.3、SVN</h3><p><img src="`+s+`" alt="68187588702"></p><h1 id="黑马程序员-北京昌平校区" tabindex="-1"><a class="header-anchor" href="#黑马程序员-北京昌平校区" aria-hidden="true">#</a> 黑马程序员 北京昌平校区</h1><h3 id="_2-4、git" tabindex="-1"><a class="header-anchor" href="#_2-4、git" aria-hidden="true">#</a> 2.4、Git</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Git是分布式的,Git不需要有中心服务器，我们每台电脑拥有的东西都是一样的。我们使用Git并且有个
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+l+'" alt="68187588702"></p><h3 id="_2-5、git工作流程图" tabindex="-1"><a class="header-anchor" href="#_2-5、git工作流程图" aria-hidden="true">#</a> 2.5、Git工作流程图</h3><p><img src="'+d+`" alt="68187588702"></p><p>命令如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. clone（克隆）: 从远程仓库中克隆代码到本地仓库
...
doc/**/*.pdf
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="练习-基础操作" tabindex="-1"><a class="header-anchor" href="#练习-基础操作" aria-hidden="true">#</a> 练习:基础操作</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#####################仓库初始化######################
# 创建目录（git_test01）并在目录下打开gitbash
略
# 初始化git仓库
git init
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#####################创建文件并提交#####################
# 目录下创建文件 file01.txt
略
# 将修改加入暂存区
git add.
...
# 查看日志
git log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>####################修改文件并提交######################
# 修改file01的内容为：count=
略
# 将修改加入暂存区
git add.
...
<span class="token comment"># [master]以精简的方式显示提交记录</span>
git-log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-、git远程仓库" tabindex="-1"><a class="header-anchor" href="#_4-、git远程仓库" aria-hidden="true">#</a> 4 、Git远程仓库</h2><h3 id="_4-1、-常用的托管服务-远程仓库" tabindex="-1"><a class="header-anchor" href="#_4-1、-常用的托管服务-远程仓库" aria-hidden="true">#</a> 4.1、 常用的托管服务[远程仓库]</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>前面我们已经知道了Git中存在两种类型的仓库，即本地仓库和远程仓库。那么我们如何搭建Git远程仓库
